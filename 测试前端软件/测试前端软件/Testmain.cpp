...
public:
	...
	virtual LRESULT HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
	{
		...
		if (uMsg == WM_CREATE)
		{
			...
			CControlUI* pRoot = builder.Create(_T("login.xml"), (UINT)0, NULL, &m_PaintManager);   // duilib.xml需要放到exe目录下
...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
	...
	Mysql mysql;
	mysql.Connection("127.0.0.1", "root", "wqwq123", "Cashier", 3306);
